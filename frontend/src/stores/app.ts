...
const knownToolIds = new Set<ToolId>(['notes', 'json', 'json-diff', 'json-java', 'java', 'timestamp', 'base64-text', 'base64-image', 'base64-file', 'cron', 'sql', 'yaml', 'xml', 'text-diff', 'text-stats', 'regex', 'md5', 'hosts', 'clipboard-history', 'calculator'])
